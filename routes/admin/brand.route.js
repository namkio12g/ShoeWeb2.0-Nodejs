...
Router.get("/add-new-brand", authMiddle.checkAuth, controller.createGet);
...
Router.post("/add-new-brand", authMiddle.checkAuth, upload.single("thumbnail"), validate.validateCategory, controller.createPatch);
